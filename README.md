...
* [🐾 Tabby](https://github.com/TabbyML/tabby) ⭐ 33,881 | 🐛 336 | 🌐 Rust | 📅 2026-06-30: An opensource / on-prem alternative to GitHub Copilot.
...
* [PraisonAI](https://github.com/MervinPraison/PraisonAI) ⭐ 9,054 | 🐛 85 | 🌐 Python | 📅 2026-09-14: Multi-AI Agents framework with 100+ LLM support, MCP integration, agentic workflows for code generation, and built-in memory.
* [TurboPilot](https://github.com/ravenscroftj/turbopilot) ⚠️ Archived: CPU based copilot clone
* [Twinny](https://github.com/rjmacarthy/twinny) ⭐ 3,639 | 🐛 48 | 🌐 TypeScript | 📅 2026-09-14: ollama based AI code completion plugin
