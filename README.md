...
* [🐾 Tabby](https://github.com/TabbyML/tabby) ⭐ 33,858 | 🐛 337 | 🌐 Rust | 📅 2026-06-30: An opensource / on-prem alternative to GitHub Copilot.
...
* [PraisonAI](https://github.com/MervinPraison/PraisonAI) ⭐ 9,008 | 🐛 71 | 🌐 Python | 📅 2026-09-03: Multi-AI Agents framework with 100+ LLM support, MCP integration, agentic workflows for code generation, and built-in memory.
* [TurboPilot](https://github.com/ravenscroftj/turbopilot) ⚠️ Archived: CPU based copilot clone
* [Twinny](https://github.com/rjmacarthy/twinny) ⭐ 3,633 | 🐛 46 | 🌐 TypeScript | 📅 2026-09-02: ollama based AI code completion plugin
