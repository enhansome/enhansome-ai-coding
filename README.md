...
* [🐾 Tabby](https://github.com/TabbyML/tabby) ⭐ 33,857 | 🐛 335 | 🌐 Rust | 📅 2026-06-30: An opensource / on-prem alternative to GitHub Copilot.
* [Fauxpilot](https://github.com/fauxpilot/fauxpilot) ⭐ 14,686 | 🐛 63 | 🌐 Python | 📅 2024-04-09: Code completion server with *CodeGen*.
...
* [PraisonAI](https://github.com/MervinPraison/PraisonAI) ⭐ 9,003 | 🐛 54 | 🌐 Python | 📅 2026-09-02: Multi-AI Agents framework with 100+ LLM support, MCP integration, agentic workflows for code generation, and built-in memory.
* [TurboPilot](https://github.com/ravenscroftj/turbopilot) ⚠️ Archived: CPU based copilot clone
* [Twinny](https://github.com/rjmacarthy/twinny) ⭐ 3,632 | 🐛 46 | 🌐 TypeScript | 📅 2026-09-02: ollama based AI code completion plugin
