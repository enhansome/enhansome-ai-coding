...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 503,943 | 🐛 106 | 📅 2026-09-02
...
* [🐾 Tabby](https://github.com/TabbyML/tabby) ⭐ 33,868 | 🐛 335 | 🌐 Rust | 📅 2026-06-30: An opensource / on-prem alternative to GitHub Copilot.
...
* [PraisonAI](https://github.com/MervinPraison/PraisonAI) ⭐ 9,028 | 🐛 55 | 🌐 Python | 📅 2026-09-07: Multi-AI Agents framework with 100+ LLM support, MCP integration, agentic workflows for code generation, and built-in memory.
* [TurboPilot](https://github.com/ravenscroftj/turbopilot) ⚠️ Archived: CPU based copilot clone
* [Twinny](https://github.com/rjmacarthy/twinny) ⭐ 3,634 | 🐛 47 | 🌐 TypeScript | 📅 2026-09-07: ollama based AI code completion plugin
* [Autodoc](https://github.com/context-labs/autodoc) ⭐ 2,367 | 🐛 24 | 🌐 TypeScript | 📅 2024-08-12: Generate codebase documentation use LLM (OpenAI / Alpaca)
...
* [CodeGeeX 13B](https://github.com/THUDM/CodeGeeX) ⭐ 8,801 | 🐛 188 | 🌐 Python | 📅 2024-08-13
...
* [Awesome AI-Powered Developer Tools](https://github.com/jamesmurdza/awesome-ai-devtools) ⭐ 3,931 | 🐛 287 | 📅 2026-08-27
